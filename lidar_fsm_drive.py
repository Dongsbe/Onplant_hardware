...
LIDAR_TO_FRONT_AXLE = float(os.getenv("ONPLANT_LIDAR_TO_FRONT_AXLE", "25"))
LIDAR_TO_LEFT_OUTER = float(os.getenv("ONPLANT_LIDAR_TO_LEFT_OUTER", "80"))
LIDAR_TO_RIGHT_OUTER = float(os.getenv("ONPLANT_LIDAR_TO_RIGHT_OUTER", "80"))
SAFETY_MARGIN = float(os.getenv("ONPLANT_LIDAR_SAFETY_MARGIN", "45"))

LEFT_CLEARANCE = LIDAR_TO_LEFT_OUTER + SAFETY_MARGIN
RIGHT_CLEARANCE = LIDAR_TO_RIGHT_OUTER + SAFETY_MARGIN

FRONT_WARN_X = LIDAR_TO_FRONT_AXLE + SAFETY_MARGIN + float(os.getenv("ONPLANT_FRONT_WARN_MM", "380"))
FRONT_DANGER_X = LIDAR_TO_FRONT_AXLE + SAFETY_MARGIN + float(os.getenv("ONPLANT_FRONT_DANGER_MM", "230"))
FRONT_EMERGENCY_X = LIDAR_TO_FRONT_AXLE + SAFETY_MARGIN + float(os.getenv("ONPLANT_FRONT_EMERGENCY_MM", "110"))
FRONT_CLEAR_X = LIDAR_TO_FRONT_AXLE + SAFETY_MARGIN + float(os.getenv("ONPLANT_FRONT_CLEAR_MM", "500"))
...
POINT_LIMIT = int(os.getenv("ONPLANT_LIDAR_POINT_LIMIT", "1"))
THIN_POINT_X = LIDAR_TO_FRONT_AXLE + SAFETY_MARGIN + float(os.getenv("ONPLANT_THIN_POINT_MM", "340"))
...
SIDE_SOFT_CLOSE_X = float(os.getenv("ONPLANT_SIDE_SOFT_CLOSE_MM", "400"))
