...
FRONT_WARN_X = LIDAR_TO_FRONT_AXLE + SAFETY_MARGIN + 190
FRONT_DANGER_X = LIDAR_TO_FRONT_AXLE + SAFETY_MARGIN + 80
FRONT_EMERGENCY_X = LIDAR_TO_FRONT_AXLE + SAFETY_MARGIN + 25
FRONT_CLEAR_X = LIDAR_TO_FRONT_AXLE + SAFETY_MARGIN + 240

POINT_LIMIT = 2
THIN_POINT_X = LIDAR_TO_FRONT_AXLE + SAFETY_MARGIN + 170
